...
function verifica(id,id2){
    ...
    if(rodada<9){
        ...
        document.getElementById('corpo').innerHTML = '<div><h1 style="text-align: center">Pontuação ' + (pontuacao) + '/10</h1></div id="reiniciar"><div style="display: flex; justify-content: center;"><img src="images/reiniciar.png" width="70" height="70"  onclick=reiniciar()></div><h3 style="text-align: center">Reiniciar jogo</h3>';
        pontuacao=0;
        rodada=0;
        perguntaAtual=0;
